...
public class ChaseEnemy: MonoBehaviour 
{
    ...
    void Update()
    {
        bool chek = GetComponent<VisionEnemy>().topVision;
        ...
        float positionBanditX = GameObject.Find("MONKEY").transform.position.x;
        float positionBanditZ = GameObject.Find("MONKEY").transform.position.z;
